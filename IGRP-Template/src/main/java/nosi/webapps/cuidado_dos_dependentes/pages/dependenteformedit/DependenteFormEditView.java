...
public class DependenteFormEditView extends View {
	...
	public DependenteFormEditView(){

		this.setPageTitle("Cadastro Dependente Atualizar");
		...
		btn_guardar = new IGRPButton("Guardar","cuidado_dos_dependentes","DependenteFormEdit","guardar","submit","primary|fa-floppy-o","","");
	...
	public void setModel(Model model) {
		...
		sl_detalhes_dependentes.loadModel(((DependenteFormEdit) model).getSl_detalhes_dependentes());
		sl_agregado_familiar.loadModel(((DependenteFormEdit) model).getSl_agregado_familiar());
		sl_contactos.loadModel(((DependenteFormEdit) model).getSl_contactos());
		sl_documentos_identificacao.loadModel(((DependenteFormEdit) model).getSl_documentos_identificacao());
		}
}
